            ...
            if(QueryType == 1) {
				...
				{ 
                    ...
                    else 
					{
						...
						{
                            int choice;
                            printf("\n Shashank Sir will not have enough time to handle this Query because of high BurstTime."
            ...
            else if(QueryType == 2) 
			{
				...
				{    
                    ...
                    printf("\nBurst Time cannot be less than 0\n"); 
						...
						{
                            int choice;
                            printf("\nShashank Sir won't have enough time to handle this Query because of high BurstTime."
                            "\nWant to change BurstTime? (1 : Yes; Else : No) ");
                            scanf("%d", &choice);
                            if(choice==1) 
							{
